...
package com.furydragons.filemanager.ui.policy;
...
import com.furydragons.filemanager.activities.EditorActivity;
import com.furydragons.filemanager.activities.ShortcutActivity;
...
import com.furydragons.filemanager.providers.SecureResourceProvider;
import com.furydragons.filemanager.providers.SecureResourceProvider.AuthorizationResource;
import com.furydragons.filemanager.providers.secure.ISecureChoiceCompleteListener;
import com.furydragons.filemanager.providers.secure.SecureCacheCleanupService;
import com.furydragons.filemanager.providers.secure.SecureChoiceClickListener;
...
public final class IntentsActionPolicy extends ActionsPolicy {
    ...
    private static final String PREFERRED_PACKAGE = "com.furydragons.filemanager"; //$NON-NLS-1$

    /**
     * Extra field for the internal action
     */
    public static final String EXTRA_INTERNAL_ACTION =
            "com.furydragons.filemanager.extra.INTERNAL_ACTION"; //$NON-NLS-1$

    /**
     * Category for all the internal app viewers
     */
    public static final String CATEGORY_INTERNAL_VIEWER =
            "com.furydragons.filemanager.category.INTERNAL_VIEWER"; //$NON-NLS-1$

    /**
     * Category for all the app editor
     */
    public static final String CATEGORY_EDITOR =
            "com.furydragons.filemanager.category.EDITOR"; //$NON-NLS-1$
