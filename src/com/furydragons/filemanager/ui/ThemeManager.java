...
package com.furydragons.filemanager.ui;
...
public final class ThemeManager {
    ...
    public static final String PERMISSION_READ_THEME =
            "com.furydragons.filemanager.permissions.READ_THEME"; //$NON-NLS-1$
    ...
    public static final String ACTION_MAIN_THEME =
            "com.furydragons.filemanager.actions.MAIN_THEME"; //$NON-NLS-1$
    ...
    public static final String CATEGORY_THEME =
            "com.furydragons.filemanager.categories.THEME"; //$NON-NLS-1$
